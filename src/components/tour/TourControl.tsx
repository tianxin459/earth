    ...
    steps: [
      {
        ...
        description: 'Welcome to the global purchase order visualization platform',
        action: 'message',
        duration: 3,
      ...
      },
      {
        ...
        description: 'Key shipping lanes connecting Asia to North America',
        action: 'camera',
        duration: 6,
        parameters: { viewpoint: { lat: 35, lng: -140, altitude: 1.8 } }
      },
      {
        id: 'us-ports',
        ...
        action: 'camera',
        duration: 8,
        parameters: { viewpoint: { lat: 35, lng: -100, altitude: 1.6 } }
      },
      {
        id: 'europe-routes',
    ...
    steps: [
      {
        ...
        description: 'Analyzing purchase order patterns and shipping costs',
        action: 'message',
        duration: 4,
        parameters: { viewpoint: { lat: 20, lng: 0, altitude: 2.5 } }
      },
    ...
    steps: [
      {
        ...
        parameters: { 
          ...
          highlights: ['SHANGHAI', 'SHENZHEN', 'HONG KONG', 'SINGAPORE']
        }
      },
      {
        id: 'europe-detail',
        ...
        parameters: { 
          ...
          highlights: ['HAMBURG', 'ROTTERDAM', 'ANTWERP', 'BARCELONA']
        }
      },
      {
        id: 'americas-detail',
        ...
        parameters: { 
          ...
          highlights: ['Los Angeles', 'New York', 'Houston', 'CALLAO']
        }
      }
    ]
  }
...
const QuickActionButton = styled.button<{ variant?: 'primary' | 'secondary' | 'accent' }>`
  background: ${props => {
    switch (props.variant) {
      case 'primary': return 'linear-gradient(135deg, #4dd0e1, #26c6da)';
      case 'accent': return 'linear-gradient(135deg, #ff6b6b, #ee5a52)';
      default: return 'rgba(77, 208, 225, 0.1)';
    }
  }};
  ...
  &:hover {
    ...
    background: ${props => {
      switch (props.variant) {
        case 'primary': return 'linear-gradient(135deg, #26c6da, #4dd0e1)';
        case 'accent': return 'linear-gradient(135deg, #ee5a52, #ff6b6b)';
        default: return 'rgba(77, 208, 225, 0.2)';
      }
    }};
  }
  ...
  const executeStep = useCallback((step: DemoStep) => {
    ...
    switch (step.action) {
      ...
      case 'data':
        ...
        console.log('Focusing on data:', step.parameters?.focus);
        break;
